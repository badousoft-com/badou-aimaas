package com.badou.project.maas.traindata.model;
 ...
 */
@Entity
@Table(name = "maas_train_data")
public class TrainDataEntity extends AppBaseEntity {
     ...
     * 模型主键
     */
	@Column(name = "Model_ids", unique = false, nullable = true, insertable = true, updatable = true)
     ...
     * 使用次数
     */
	@Column(name = "Use_count", unique = false, nullable = true, insertable = true, updatable = true)
    protected Integer useCount;
    
	/**
     * 模型名称
     */
	@Column(name = "Midel_names", unique = false, nullable = true, insertable = true, updatable = true)
