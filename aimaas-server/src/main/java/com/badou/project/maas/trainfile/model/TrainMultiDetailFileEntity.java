 ...
 */
@Entity
@Table(name = "maas_multi_train_file_detail")
public class TrainMultiDetailFileEntity extends AppBaseEntity {
     ...
     * 多模态数据主键
     */
	@Column(name = "Muti_train_id", unique = false, nullable = true, insertable = true, updatable = true)
