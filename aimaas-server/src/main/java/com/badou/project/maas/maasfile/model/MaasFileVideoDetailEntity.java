 ...
 */
@Entity
@Table(name = "maas_file_video_detail")
public class MaasFileVideoDetailEntity extends AppBaseEntity {
     ...
     * 视频管理主键
     */
	@Column(name = "File_video_id", unique = false, nullable = true, insertable = true, updatable = true)
    protected String fileVideoId;
