package com.badou.project.maas.traindataproblem.model;
 ...
 */
@Entity
@Table(name = "maas_train_data_problem")
public class TrainDataProblemEntity extends AppBaseEntity {
     ...
     * 样本集主键
     */
	@Column(name = "Problem_id", unique = false, nullable = true, insertable = true, updatable = true)
