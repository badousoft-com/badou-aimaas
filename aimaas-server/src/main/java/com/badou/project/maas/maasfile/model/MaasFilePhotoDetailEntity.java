 ...
 */
@Entity
@Table(name = "maas_file_photo_detail")
public class MaasFilePhotoDetailEntity extends AppBaseEntity {
     ...
     * 图片管理主键
     */
	@Column(name = "File_photo_id", unique = false, nullable = true, insertable = true, updatable = true)
    protected String filePhotoId;
     ...
     * 设置图片管理主键
     */
    public void setFilePhotoId(String filePhotoId) {
