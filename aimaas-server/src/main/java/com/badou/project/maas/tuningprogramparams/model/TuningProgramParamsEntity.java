package com.badou.project.maas.tuningprogramparams.model;
 ...
 */
@Entity
@Table(name = "maas_fine_tuning_program_params")
public class TuningProgramParamsEntity extends AppBaseEntity {
