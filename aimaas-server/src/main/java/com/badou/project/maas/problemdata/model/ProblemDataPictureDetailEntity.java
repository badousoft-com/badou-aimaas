 ...
 */
@Entity
@Table(name = "maas_problem_data_picture_detail")
public class ProblemDataPictureDetailEntity extends AppBaseEntity {
     ...
     * 图片样本集主键
     */
	@Column(name = "Data_picture_id", unique = false, nullable = true, insertable = true, updatable = true)
    protected String dataPictureId;
     ...
     * 获取图片样本集主键
     */
    public String getDataPictureId() {
        return dataPictureId;
    }

	/**
     * 设置图片样本集主键
     */
    public void setDataPictureId(String dataPictureId) {
        this.dataPictureId = dataPictureId;
    }
    /**
     * 获取文件名称
     */
