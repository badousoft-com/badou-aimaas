package com.badou.project.maas.tuningevaquestion.model;
 ...
 */
@Entity
@Table(name = "maas_fine_tuning_eva_question")
public class TuningEvaQuestionEntity extends AppBaseEntity {
    /**
     * 评价主键
     */
    @Column(name = "evd_Id", unique = false, nullable = true, insertable = true, updatable = true)
    protected String evdId;
    /**
     * 计划主键
     */
